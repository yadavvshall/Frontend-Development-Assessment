manifest = [
    ...
    { src: 'pages/images/Topic01/T01P91/baby.png', id: '11' },
...
var audioPath = "pages/audio/Topic01/T01P91/T01P91";
...
var updateContentArray = [
    ...
    { time: "0.0", carry: "", event: "", show: "", hide: "", transcript: "Calculate the IV rate for Baby Conrad." }, { time: "2.9", carry: "", event: "", show: "", hide: "", transcript: "", animation: [{ target: ".small_expand", duration: "0.5", activity: { 'opacity': '1', 'display': 'block' } }] }, { time: "2.9", carry: "", event: "", show: "", hide: "", transcript: "", animation: [{ target: ".clickToEnlarge", duration: "0.5", activity: { 'opacity': '1', 'display': 'block' } }] }
...
function submitClick() {
    ...
    $('.option').each(function(index) {
        ...
        if (index != correctOptions[1] && $(this).hasClass('clicked')) {
            $(this).addClass('wrong');
            incorrectCount++;
        }
